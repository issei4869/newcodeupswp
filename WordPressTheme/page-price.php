    ...
    <div class="mv__inner">
      ...
      <div class="mv__swiper">
        <picture class="mv__swiper-img">
          <source media="(min-width: 376px)" srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/sub-price-mv1_pc.jpg">
          <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sub-price-mv1_sp.jpg" alt="ダイバーの画像">
        </picture>
      </div>
    </div>
  </section>
